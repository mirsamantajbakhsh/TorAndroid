package ir.mstajbakhsh.torandroid.Connection;
...
import ir.mstajbakhsh.torandroid.TorProxy;
...
public class Address {
    ...
    private void createInnerHandler() {
        ...
        p = new Proxy(Proxy.Type.SOCKS, new InetSocketAddress("127.0.0.1", TorProxy.SOCKS_PORT));
